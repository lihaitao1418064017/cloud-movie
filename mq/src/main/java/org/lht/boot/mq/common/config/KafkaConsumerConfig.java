...
public class KafkaConsumerConfig {
    ...
    public ConcurrentKafkaListenerContainerFactory<String, KafkaMessage> basicKafkaListenerContainerFactory() {
        ...
        configProps.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, ValueDeserializer.class);
        ...
        ConsumerFactory<String, KafkaMessage> basicConsumerFactory =
                new DefaultKafkaConsumerFactory(configProps, new StringDeserializer(), new ValueDeserializer());

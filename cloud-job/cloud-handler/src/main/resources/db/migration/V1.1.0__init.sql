/*
 ...
 Source Schema         : cloud_xxl_job

 Target Server Type    : MySQL
 Target Server Version : 80016
 File Encoding         : 65001

 Date: 14/09/2020 14:53:08
*/
...
-- ----------------------------
INSERT INTO `xxl_job_group` VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, 'http://192.168.0.105:9999/');
...
-- ----------------------------
INSERT INTO `xxl_job_log` VALUES (1, 1, 1, NULL, 'demoJobHandler', '', NULL, 0, '2020-09-12 11:25:56', 500, '任务触发类型：手动触发<br>调度机器：192.168.0.105<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 1);
INSERT INTO `xxl_job_log` VALUES (2, 1, 1, NULL, 'demoJobHandler', '', NULL, 0, '2020-09-12 11:30:28', 500, '任务触发类型：手动触发<br>调度机器：192.168.0.105<br>执行器-注册方式：自动注册<br>执行器-地址列表：null<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>调度失败：执行器地址为空<br><br>', NULL, 0, NULL, 1);
INSERT INTO `xxl_job_log` VALUES (3, 1, 1, 'http://192.168.0.105:9999/', 'demoJobHandler', '', NULL, 0, '2020-09-12 11:37:14', 500, '任务触发类型：手动触发<br>调度机器：192.168.0.105<br>执行器-注册方式：自动注册<br>执行器-地址列表：[http://192.168.0.105:9999/]<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>触发调度：<br>address：http://192.168.0.105:9999/<br>code：500<br>msg：xxl-rpc remoting error(Connection refused (Connection refused)), for url : http://192.168.0.105:9999/run', NULL, 0, NULL, 1);
INSERT INTO `xxl_job_log` VALUES (4, 1, 1, 'http://192.168.0.105:9999/', 'demoJobHandler', '', NULL, 0, '2020-09-12 11:50:41', 200, '任务触发类型：手动触发<br>调度机器：192.168.0.105<br>执行器-注册方式：自动注册<br>执行器-地址列表：[http://192.168.0.105:9999/]<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>触发调度：<br>address：http://192.168.0.105:9999/<br>code：200<br>msg：null', '2020-09-12 11:50:51', 200, '', 0);
INSERT INTO `xxl_job_log` VALUES (5, 1, 1, 'http://192.168.0.105:9999/', 'demoJobHandler', '', NULL, 0, '2020-09-12 11:57:52', 200, '任务触发类型：手动触发<br>调度机器：192.168.0.105<br>执行器-注册方式：自动注册<br>执行器-地址列表：[http://192.168.0.105:9999/]<br>路由策略：第一个<br>阻塞处理策略：单机串行<br>任务超时时间：0<br>失败重试次数：0<br><br><span style=\"color:#00c0ef;\" > >>>>>>>>>>>触发调度<<<<<<<<<<< </span><br>触发调度：<br>address：http://192.168.0.105:9999/<br>code：200<br>msg：null', '2020-09-12 11:58:02', 200, '', 0);
...
-- ----------------------------
INSERT INTO `xxl_job_log_report` VALUES (1, '2020-09-12 00:00:00', 0, 2, 3);
INSERT INTO `xxl_job_log_report` VALUES (2, '2020-09-11 00:00:00', 0, 0, 0);
INSERT INTO `xxl_job_log_report` VALUES (3, '2020-09-10 00:00:00', 0, 0, 0);

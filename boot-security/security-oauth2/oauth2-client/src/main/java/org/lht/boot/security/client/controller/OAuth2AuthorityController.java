...
import org.lht.boot.security.core.service.OAuth2Authentication;
...
public class OAuth2AuthorityController {
    ...
    @GetMapping("/me")
    public R me() {
        PreAuthenticatedAuthenticationToken authentication = (PreAuthenticatedAuthenticationToken) OAuth2Authentication.getAuthentication();

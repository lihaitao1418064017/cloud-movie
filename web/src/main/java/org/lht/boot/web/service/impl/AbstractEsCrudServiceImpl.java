 ...
 **/
public class AbstractEsCrudServiceImpl<E extends CrudEntity<PK>, PK extends Serializable, Dao extends AbstractElasticSearchCrudDao<E, PK>> implements AbstractEsCrudService<E, PK, Dao> {
